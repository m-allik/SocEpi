...
When SII is estimated via weighted least squares the weights will be equal to the square root of the population share of each age group; $SII = (X'WX)^{-1} X'Wy)$. The relative index of inequality is calculated as $RII = SII/\mu$, where $\mu$ is the mean level of health across all socioeconomic statuses.
